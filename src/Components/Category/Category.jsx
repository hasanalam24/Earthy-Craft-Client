...
const Category = () => {
    ...
    return (
        <div>
            ...
            <div className="w-[98%] mx-auto grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {
                    categoryItems.map(item => <div key={item._id} className="card card-compact  bg-base-100 shadow-xl">
